...
exports.convertToSqlV1Format = convertToSqlV1Format;
exports.jsonToArrowTable = jsonToArrowTable;
 ...
 */
function convertToSqlV1Format(jsonData, _isSpiceAI = false) {
 ...
 */
function jsonToArrowTable(schema, rows) {
    ...
    if (rows.length === 0) {
        ...
        const table = (0, apache_arrow_1.tableFromArrays)(columns);
    ...
    try {
        ...
        try {
            const table = (0, apache_arrow_1.tableFromArrays)(simpleColumns);
            // Attach original schema metadata for type conversion
            table._originalSchema = schema;
            return table;
        }
            ...
            const table = (0, apache_arrow_1.tableFromArrays)(stringColumns);
            // Attach original schema metadata for type conversion
            table._originalSchema = schema;
            return table;
        }
