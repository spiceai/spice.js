 ...
 */
export type ArrowTypeId = 'Int8' | 'Int16' | 'Int32' | 'Int64' | 'UInt8' | 'UInt16' | 'UInt32' | 'UInt64' | 'Float16' | 'Float32' | 'Float64' | 'String' | 'LargeString' | 'Binary' | 'LargeBinary' | 'FixedSizeBinary' | 'Boolean' | 'Date32' | 'Date64' | 'Time32' | 'Time64' | 'Timestamp' | 'Duration' | 'Decimal128' | 'Decimal256' | 'Null';
/**
...
export declare class Param {
     ...
     */
    static fixedSizeBinary(value: Buffer | Uint8Array, options: FixedSizeBinaryOptions): Param;
    /**
     ...
     */
    static timestamp(value: Date | number | bigint, options?: TimestampOptions): Param;
    /**
