...
describe('Performance Tests', () => {
  ...
  describe('Query Performance', () => {
    skipIfNoRuntime()('.sql() should complete small queries quickly', async () => {
    ...
    skipIfNoRuntime()('.sql() should handle medium result sets efficiently', async () => {
      const startTime = performance.now();
    ...
    skipIfNoRuntime()('.sql() with toArray() should be performant', async () => {
      const startTime = performance.now();
  ...
  describe('sqlJson Performance', () => {
    skipIfNoRuntime()('.sqlJson() should complete small queries quickly', async () => {
      const startTime = performance.now();
    ...
    skipIfNoRuntime()('.sqlJson() should handle medium result sets efficiently', async () => {
      const startTime = performance.now();
    ...
    skipIfNoRuntime()('.sqlJson() should have minimal overhead compared to .sql()', async () => {
      const query =
        'SELECT * FROM test_postgresql_table_not_accelerated LIMIT 100';
  ...
  describe('Streaming Performance', () => {
    skipIfNoRuntime()('.sql() with callback should handle chunks efficiently', async () => {
      const chunks: number[] = [];
      const startTime = performance.now();
    ...
    skipIfNoRuntime()('streaming should not have excessive per-chunk overhead', async () => {
  ...
  describe('Concurrent Query Performance', () => {
    skipIfNoRuntime()('should handle multiple concurrent .sql() queries efficiently', async () => {
    ...
    skipIfNoRuntime()('should handle multiple concurrent .sqlJson() queries efficiently', async () => {
      const queries = Array(5).fill(
        'SELECT * FROM test_postgresql_table_not_accelerated LIMIT 100',
      );
  ...
  describe('Memory Efficiency', () => {
    skipIfNoRuntime()('.sql() should not cause excessive memory allocation for large results', async () => {
      if (global.gc) {
    ...
    skipIfNoRuntime()('.sqlJson() should not cause excessive memory allocation', async () => {
      if (global.gc) {
        global.gc(); // Force GC if --expose-gc flag is set
      }
  ...
  describe('Cold Start Performance', () => {
    skipIfNoRuntime()('first query should not have excessive initialization overhead', async () => {
      ...
      console.log(`  ✓ Cold start query completed in ${duration.toFixed(2)}ms`);
    });
  });
});
